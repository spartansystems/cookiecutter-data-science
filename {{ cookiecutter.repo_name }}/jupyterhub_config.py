...
# c.JupyterHub.data_files_path = '/Users/mjs2600/.pyenv/versions/3.5.2/envs/jupyterhub/share/jupyter/hub'
...
# c.SystemUserSpawner.host_homedir_format_string = '/Users/{username}'
...
# c.NotebookApp.notebook_dir = os.path.basename(__file__)

project_dir = os.path.dirname(__file__)
c.Spawner.notebook_dir = os.path.join(project_dir, 'notebooks')
